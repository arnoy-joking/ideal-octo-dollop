...
3.  **Balance Subjects & Avoid Monotony:** Distribute the courses as evenly as possible throughout the period. A user should not study the same subject at the same time every day. Actively rotate the subjects to keep the schedule interesting and engaging. Avoid creating monotonous, repetitive daily patterns.
4.  **Schedule ALL Lessons:** You MUST schedule ALL lessons for ALL courses provided in the input within the given date range. Do not skip any lessons. Distribute the lessons as evenly as possible, even if it means scheduling many lessons on some days to fit everything.
